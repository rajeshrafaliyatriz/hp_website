const features = [
  {
    title: "Succession Risk Analysis",
    description:
      "Identify leadership vulnerabilities before they impact business continuity.",
    icon:
  ...
  },
  {
    ...
    description:
      "Spot high-potential individuals with data-backed assessments and behavioral insights.",
    icon:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/18d08cc37dc693d55e86c5d519c13c6b8e141432?width=100",
  },
  {
    title: "Bench Strength Simulator",
    description:
      "Evaluate leadership readiness across teams and roles to close pipeline gaps proactively.",
    icon:
  ...
  },
  {
    ...
    description:
      "Align leadership strategies with long-term growth goals and reduce key talent dependencies.",
    icon:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/6262300b6b3f871e6d7fd33f9022bcc71bda4e8a?width=100",
  },
  {
    title: "Leadership Continuity Planning",
    description:
      "Prepare future leaders with structured learning paths, mentoring, and rotational programs.",
    icon:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/18d08cc37dc693d55e86c5d519c13c6b8e141432?width=100",
  },
];
