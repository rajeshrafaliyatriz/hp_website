...
const ClientSection = () => {
  ...
  return (
    <section className="flex overflow-hidden flex-col pt-2 pb-2 mt-10 mb-6 w-full lg:text-3xl sm:text-xl font-bold text-center text-amber-500 bg-blue-100 bg-opacity-80">
