    ...
    <div className="relative lg:py-20 sm:py-10 bg-white overflow-hidden">
      ...
      <div className="max-w-[1440px] lg:mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              ...
              <p className="font-prompt text-lg lg:text-xl text-gray-600 max-w-lg mx-auto">
                We provide four categories of services and you will get high
                quality services from here
              </p>
            </div>
