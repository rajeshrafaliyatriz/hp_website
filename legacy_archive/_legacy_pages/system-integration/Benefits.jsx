...
const benefits = [
  {
    ...
    description:
      'Automation cuts hours off routine workflows like onboarding, payroll updates, and attendance logs. ',
  },
  {
    title: ' Improved Data Integrity',
    description:
      'Reduce errors and ensure accurate records across all modules with real-time data syncing.',
  },
  {
    title: 'Plug-and-Play Extensibility',
    description:
      'Easily integrate new tools as your needs evolve—without disrupting existing workflows.',
  },
  {
    title: 'Scalable Architecture',
    description:
      'Designed to grow with your institution handle thousands of users, processes, and data points. ',
  },
];
      ...
      <div className="max-w-[1440px] lg:mx-20 sm:mx-10">
        ...
        <div className="text-center">
          <h2 className="font-open-sans text-4xl sm:text-2xl md:text-6xl lg:text-[50px] font-bold text-[#014D68] leading-normal">
            Let System Integration make it effortless, automated, and future-ready.
          </h2>
        </div>
      </div>
    </section>
