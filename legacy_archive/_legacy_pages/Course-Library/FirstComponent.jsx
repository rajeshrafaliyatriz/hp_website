      ...
      <div className="max-w-[1440px] lg:mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              <h2 className="font-prompt font-medium text-4xl lg:text-5xl text-payroll-dark mb-6">
               What&rsquo;s Inside the Course Library? 
              </h2>
              <p className="font-prompt text-lg lg:text-xl text-gray-600 max-w-1xl mx-auto">
               Whether you&rsquo;re onboarding new hires, empowering frontline workers, or upskilling your salesforce, our curated collection has you covered—with learning that actually sticks. 
              </p>
            </div>
