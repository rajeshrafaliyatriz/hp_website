        ...
        <div className="max-w-[1561px] lg:mx-20 px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-start">
            ...
            <div className="space-y-6 lg:space-y-6">
              ...
              What You&rsquo;ll Experience With Mobile Learning
              </p>
              ...
              <div className="space-y-6 lg:space-y-4">
                ...
                <div className="max-w-[707px]">
                  ...
                  <p className="font-open-sans text-lg lg:text-1xl text-black">
                    Log in from any mobile device with an optimized interface that ensures frictionless learning from day one. 
                  </p>
                </div>
                ...
                <div className="max-w-[647px]">
                  ...
                  <p className="font-open-sans text-lg lg:text-1xl text-black">
                    Download entire lessons, quizzes, or modules with a single tap. Study offline—no signal, no problem.
                  </p>
                </div>
                ...
                <div className="max-w-[647px]">
                  <h3 className="font-open-sans text-xl lg:text-[20px] font-bold text-black mb-1">
                  Phase 3: Stay Notified & Motivated
                  </h3>
                  <p className="font-open-sans text-lg lg:text-1xl text-black">
                    Receive reminders, progress updates, and upcoming task alerts via WhatsApp, SMS, or push notifications. 
                  </p>
                </div>
              </div>
