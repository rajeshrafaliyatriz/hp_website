  ...
  return (
    <div className="h-fit" style={{ backgroundColor: "rgba(115, 233, 226, 0.2)" }}>
      <section className="relative flex items-center justify-center px-4 sm:px-8 lg:px-20 xl:px-24 py-6 lg:py-14">
        <div className="lg:max-w-7xl w-full lg:grid grid-cols-2 gap-8 items-center">
          {/* Left Content */}
          <div className="space-y-9 lg:space-y-14">
            {/* Main Heading */}
            <div className="self-stretch lg:text-4xl sm:text-2xl font-bold leading-tight max-md:text-3xl">
              <span className="text-black">Ignite Success with Strategic </span>
              <span className="text-teal-500">Vision</span>
              <span className="text-black">, Insightful</span>
              <span className="text-teal-500">Expertise</span>
              <span className="text-black">, and a Focus on Lasting </span>
              <span className="text-teal-500">Impact</span>
              <span className="text-black">.</span>
            </div>

            {/* Sub-heading */}
            <p className="text-brand-light-gray mt-6 text-xl font-medium leading-8 text-zinc-600 w-[90%] max-md:w-full">
              Spark growth by integrating seamless onboarding processes,
              leveraging actionable talent insights, and implementing
              forward-thinking strategies to prepare your organization for
          ...
          {/* Right Images */}
          <div className="lg:relative flex justify-center lg:justify-end">
            ...
            <div className="relative z-10 flex items-center justify-center lg:justify-end">
              <img
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/8df5b41fb2ae7dfed2a63b824c6b823f367f75a1?width=1480"
