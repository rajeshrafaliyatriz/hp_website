        ...
        <div className="relative bg-[linear-gradient(to_right,_#CFF4F2_0%,_#9DE9E4_50%,_#CFF4F2_100%)] pt-12 sm:pt-16 lg:pt-28">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-8">
            <h1 className="text-[26px] sm:text-[32px] md:text-[42px] lg:text-[48px] font-bold text-[#014D68] leading-tight mb-3">
              Effortless Leave Requests. Seamless Approvals. <br />
            ...
            <p className="text-sm sm:text-base md:text-lg text-black max-w-3xl mx-auto leading-relaxed mb-6">
             Say goodbye to paper forms, endless email threads, and confusion over leave balances. Our Leave Management system makes applying, tracking, and approving leave requests simple and transparent  for employees, managers, and HR teams alike.
            </p>
            ...
            ">
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-4 gap-6 sm:gap-8">
                  {[
                    {
                      title: "Apply Leave in Seconds",
                      desc: `Employees can submit leave requests with an intuitive step-by-step form, including:
                      Leave type selection via dropdown menu.Date selection with an interactive calendar. Reason input for clarity and transparency.
`,
                    },
                    {
                      title: "Track “My Leave” Easily",
                      desc: `Stay on top of your leave history with a clear, organized table showing: Leave type, date range, and status. Quick view of approvals and rejections. Downloadable approval letters for official use`,
                    },
                    {
                      title: "Streamlined Leave Authorisation for Managers & HR",
                      desc: `Approve requests quickly and fairly with a dedicated authorisation dashboard: View employee name, leave type, dates, and reasons. Add optional comments before approving or rejecting. Bulk approve multiple requests in one click`,
                    },
                    {
                      title: "Essential Features for Smarter Leave Management",
                      desc: `Conflict & Balance Validation – Prevents approval of leaves that exceed available balances or overlap with existing bookings. Real-Time Notifications – Keeps employees updated on request status instantly. `,
                    },
                  ].map((item, idx) => (
                    <div
                      key={idx}
