...
const Second = ({
  title = "Unlock the Power of Data-Driven Talent Management",
  description = "Our Competency Matrix empowers leaders to make smarter, faster workforce decisions by offering: ",
  benefits = [
    {
      category: "People Analytics:",
      description:
        "Spot high performers and hidden talent.",
    },
    {
      category: "Learning & Development Planning:",
      description:
        "Guide training investments based on actual need. ",
    },
    {
      category: "Succession Planning:",
      description:
        "Identify future leaders with potential scoring.",
    },
    {
      category: "Workforce Readiness: ",
      description:
        "Ensure your teams are ready for tomorrow's challenges. ",
    }
  ],
