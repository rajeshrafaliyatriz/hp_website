          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-start">
            ...
            <div className="space-y-6 lg:space-y-6">
              ...
              <p className="font-urbanist text-lg lg:text-sm font-semibold text-[#026A8F] uppercase tracking-wider">
               What You&rsquo;ll Unlock with Growth Predictor 
              </p>
              ...
              <div className="space-y-6 lg:space-y-4">
                ...
                <div className="max-w-[707px]">
                  ...
                  Phase 1: Detect & Forecast
                  </h3>
                  <p className="font-open-sans text-lg lg:text-1xl text-black">
                    Analyze existing team capabilities and use AI-driven models to forecast future talent needs based on organizational goals and market trends. 
                  </p>
                </div>
                ...
                <div className="max-w-[647px]">
                  ...
                  <p className="font-open-sans text-lg lg:text-1xl text-black">
                    Match roles with required skills. Identify high-risk areas and auto-map employees to tailored development paths aligned with business goals. 
                  </p>
                </div>
                ...
                <div className="max-w-[647px]">
                  <h3 className="font-open-sans text-xl lg:text-[20px] font-bold text-black mb-1">
                  Phase 3: Develop & Track
                  </h3>
                  <p className="font-open-sans text-lg lg:text-1xl text-black">
                    Deploy auto-generated learning journeys and track real-time progress with dashboards designed for HR leaders, L&D managers, and team heads.
                  </p>
                </div>
              </div>
