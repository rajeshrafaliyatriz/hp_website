          ...
          <div className="grid lg:grid-cols-[700px_1fr] gap-8 lg:gap-12 items-center ">
            ...
            <div className="space-y-6 lg:space-y-6 ml-5">
              ...
              <h1 className="font-urbanist text-3xl sm:text-4xl lg:text-[38px] font-bold leading-tight lg:leading-[50.2px]">
                <span className="text-sales-text">Predict Skills Gaps Before <br/>They Hurt You </span>
              ...
              <p className="font-urbanist text-lg sm:text-xl lg:text-[19px] text-sales-subtitle font-medium leading-relaxed lg:leading-[34.5px] max-w-[465px]">
                Empower your organization with foresight. Growth Predictor leverages smart analytics to forecast emerging skill gaps, design personalized development paths, and future-proof your workforce with precision. Don&rsquo;t wait for productivity to decline—stay ahead with real-time insights and proactive learning strategies. 
              </p>
