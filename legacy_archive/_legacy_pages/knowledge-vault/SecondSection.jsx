const features = [
  {
    title: "Digital Handbook Creator",
    description:
      "Easily build, update, and distribute employee handbooks, SOPs, and guides all in one place.",
    icon:
  ...
  },
  {
    ...
    description:
      "Store and organize policies, templates, manuals, and more with secure role-based access.",
    icon:
  ...
  },
  {
    ...
    description:
      "Step-by-step workflows to ensure consistent operations, training, and task execution.",
    icon:
  ...
  },
  {
    ...
    description:
      "Find what you need instantly with intelligent search, filters, and document categorization.",
    icon:
  ...
  },
  {
    ...
    description:
      "Maintain transparency with real-time updates, revision history, and user access tracking.",
    icon:
      "https://cdn.builder.io/api/v1/image/assets/TEMP/18d08cc37dc693d55e86c5d519c13c6b8e141432?width=100",
  },
];
        ...
        <div className="max-w-[1505px] lg:mx-40 px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 lg:mb-22">
            <h2 className="font-urbanist text-2xl sm:text-3xl lg:text-[34px] font-semibold text-sales-primary leading-[55.2px]">
               Why Choose the Knowledge Vault? 
            </h2>
          </div>
