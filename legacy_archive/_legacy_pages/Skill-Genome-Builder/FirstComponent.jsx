      ...
      <div className="max-w-[1440px] lg:mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              <h2 className="font-prompt font-medium text-4xl lg:text-5xl text-black mb-6">
                What Is the Skill Genome Builder? 
              </h2>
              <p className="font-prompt text-lg lg:text-xl text-gray-600 max-w-1xl mx-auto">
                It&rsquo;s not just a tool—it&rsquo;s your organization&rsquo;s custom skill taxonomy engine, built to decode capabilities, track relationships, and structure competencies in a way that makes learning, hiring, and upskilling smarter. 
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:mx-40 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
              ...
              <div className="flex flex-col items-center">
                <div className="w-40 h-40 rounded-[32px] border-2 border-black bg-white shadow-[6px_6px_0px_0px_#000] flex items-center justify-center mb-6">
                  <div className="relative w-[71px] h-[63px]">
                    {/* Network/Grid Icon */}
                    <div className="absolute inset-0">
                      <div className="w-[60px] h-[52px] border-4 border-black absolute left-[6px] top-[6px]"></div>
                      <div className="w-[15px] h-[13px] border-4 border-black bg-yellow-300 absolute left-0 top-0"></div>
                      <div className="w-[15px] h-[13px] border-4 border-black bg-yellow-300 absolute left-0 top-[50px]"></div>
                      <div className="w-[15px] h-[13px] border-4 border-black bg-yellow-300 absolute left-[57px] top-0"></div>
                      <div className="w-[15px] h-[13px] border-4 border-black bg-yellow-300 absolute left-[57px] top-[50px]"></div>
                    </div>
                  </div>
                </div>
