      ...
      <div className="max-w-[1440px] mx-auto relative px-4 xl:px-0">
        ...
        <div className="h-fit relative flex items-center">
          <div className="w-full grid lg:grid-cols-2 gap-8 lg:gap-0 items-center">
            ...
            <div className="relative lg:pl-[6.5%] order-2 pb-0 lg:order-1">
            ...
            <div className="lg:pr-[12.6%] flex flex-col justify-center order-1 lg:order-2">
              ...
              <div className="mb-8 md:mb-10 lg:mb-[44px]">
                <h1
                  ...
                  style={{
                    ...
                    lineHeight: "clamp(38px, 4.03vw, 58px)",
                    color: "#12141D",
                    fontFamily:
                ...
                >
                  A streamlined recruitment platform enhances the hiring process
                  by automating and organizing every step—from job posting to
                  candidate selection.
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div
                  className="text-center lg:text-right"
                  style={{ maxWidth: "538px", marginLeft: "auto" }}
                >
                  <span
                    style={{
                      fontSize: "clamp(16px, 1.39vw, 20px)",
                  ...
                  >
                    Publish jobs across multiple platforms and track performance
                    in real time.
                  </span>
                </div>
                ...
                >
                  ...
                  >
                    Automatically filter resumes based on skills and experience
                    to shortlist top candidates.
                  </span>
                </div>
                ...
                >
                  ...
                  >
                    Coordinate interviews, manage schedules, and gather feedback
                    in one place.
                  </span>
                </div>
                ...
                <div
                  className="text-center lg:text-right"
                  style={{ maxWidth: "486px", marginLeft: "auto" }}
                >
                  <span
                    style={{
                      fontSize: "clamp(16px, 1.39vw, 20px)",
                  ...
                  >
                    Use tests and evaluations to assess skills and fit before
                    interviews.
                  </span>
                </div>
              </div>
