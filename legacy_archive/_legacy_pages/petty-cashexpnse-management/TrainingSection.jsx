...
const features = [
  {
    title: "Customizable for Any Business",
    description:
      "Retail, offices, schools, or NGOs set up petty cash rules your way.",
  },
  {
    title: "Real-World Proven",
    description:
      " Used by businesses to cut unnecessary expenses and boost transparency.",
  },
  {
    title: "Certified Compliance",
    description:
      "Helps maintain financial documentation for audits and regulations.",
  },
];
                            ...
                            <div className="text-center lg:text-left space-y-6 lg:space-y-8 max-w-[848px]">
                                ...
                                <h2 className="font-urbanist text-3xl sm:text-4xl lg:text-[33px] font-extrabold leading-tight">
                                    <span className="text-sales-text">
                                       Join the Smart Way to Manage Petty Cash –{" "}
                                    </span>
                                ...
                                <p className="font-open-sans text-xl lg:text-[21px] text-sales-subtitle max-w-[800px] mx-auto lg:mx-0">
                                    Unlock full visibility, prevent overspending, and keep every rupee/dollar accounted for.
                                </p>
