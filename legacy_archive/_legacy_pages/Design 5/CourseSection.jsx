          ...
          <div className="grid lg:grid-cols-[auto_1fr] gap-8 lg:gap-16 items-start">
            ...
            <div className="space-y-6 lg:space-y-6">
              ...
              <p className="font-space-grotesk text-xl lg:text-lg text-course-description font-medium leading-relaxed max-w-[761px]">
                Sales success is about mindset, strategy, and execution. This
                course equips you with the confidence, techniques, and
                real-world skills to close deals and build lasting client
              relationships. Whether you&apos;re a beginner or a pro, you&apos;ll master
                the psychology and tactics to excel.
              </p>
              ...
              <div className="space-y-6 lg:space-y-4">
                ...
                <div className="max-w-[707px]">
                  ...
                  Phase 1: Attitude Shift Build a Winning Sales Mindset
                  </h3>
                  <p className="font-open-sans text-lg lg:text-1xl text-black">
                    Unlock confidence and resilience to overcome sales anxiety
                    and stay motivated.
                  </p>
                </div>
                ...
                <div className="max-w-[647px]">
                  <h3 className="font-open-sans text-xl lg:text-[20px] font-bold text-black mb-1">
                    Phase 2: Mastering Sales Knowledge & Techniques
                  </h3>
                  <p className="font-open-sans text-lg lg:text-1xl text-black">
                    Understand customer psychology, master persuasion, and
                ...
                <div className="max-w-[647px]">
                  <h3 className="font-open-sans text-xl lg:text-[20px] font-bold text-black mb-1">
                  Phase 3: Practical Application  Selling in the Real World
                  </h3>
                  <p className="font-open-sans text-lg lg:text-1xl text-black">
                    Apply your skills through real-world role-playing,
                    prospecting, and customized sales pitches.
                  </p>
                </div>
              </div>
