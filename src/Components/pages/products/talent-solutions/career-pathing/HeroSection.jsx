        ...
        <div className="relative bg-[linear-gradient(to_right,_#CFF4F2_0%,_#9DE9E4_50%,_#CFF4F2_100%)] pt-12 sm:pt-16 lg:pt-28">
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-8">
            <h1 className="text-[26px] sm:text-[32px] md:text-[42px] lg:text-[48px] font-bold text-[#014D68] leading-tight mb-3">
              Empower Growth. Map Futures. Unlock Potential. 
            </h1>
            <h2 className="text-lg sm:text-xl md:text-2xl lg:text-[22px] font-semibold text-brand-dark mb-4 sm:mb-6">
              The Smarter Way to Grow Careers 
            </h2>
            <p className="text-sm sm:text-base md:text-lg text-black max-w-3xl mx-auto leading-relaxed mb-6">
               Give your team a reason to grow within build structured, transparent career roadmaps powered by intelligent skill-to-role matching. 
            </p>
            ...
            ">
              <div>
                <h2 className="relative text-[20px] sm:text-[22px] md:text-[32px] font-bold text-[#014D68] text-center mb-10">
                  Why Choose Our Career Pathing Platform?
                </h2>
                  ...
                  {[
                    {
                      ...
                      desc: `Help employees visualize their growth journey with intuitive career paths aligned to skills, roles, and organizational needs. `,
                    },
                    {
                      title: "Your Promotion Roadmap ",
                      desc: `Show clear steps to advancement. Let team members know exactly what skills and experiences they need to move up.`,
                    },
                    {
                      title: "Skills-to-Role Mapping ",
                      desc: `Automatically map current skills to potential roles across the organization. Identify gaps and suggest learning plans. `,
                    },
                    {
                      title: "Internal Mobility Board ",
                      desc: `Promote talent from within. Highlight open roles and match them to employees ready for their next move. `,
                    },
                  ].map((item, idx) => (
                    <div
                      key={idx}
