...
const benefits = [
  {
    ...
    description:
      'Spot skill shortages and surpluses in advance. Stay future-ready. ',
  },
  {
    title: 'Accurate Role Fitment',
    description:
      'Match roles to strengths. Increase job satisfaction and output.',
  },
  {
    title: 'Upskilling ROI Visibility',
    description:
      'Measure training effectiveness based on pre/post skill scores.',
  },
  {
    title: 'Automated Career Mapping',
    description:
      'Suggest career paths and internal mobility options instantly.',
  },
];
      ...
      <div className="max-w-[1440px] lg:mx-20 sm:mx-10">
        ...
        <div className="text-center">
          <h2 className="font-open-sans text-4xl sm:text-2xl md:text-6xl lg:text-[52px] font-bold text-[#014D68] leading-normal">
            Empower Talent. Build for the Future. 
          </h2>
        </div>
      </div>
    </section>
