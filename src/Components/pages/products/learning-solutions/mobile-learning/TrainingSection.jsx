...
const features = [
  {
    title: "Truly Offline Learning ",
    description:
      "Not just cached pages. Fully downloadable content with tracking and progress retention",
  },
  {
    title: "Designed for All Devices",
    description:
      " Compatible across Android & iOS with a UI that adapts to every screen size.",
  },
  {
    title: "Built-In Notifications System",
    description:
      "WhatsApp & SMS integrations to drive learning consistency and avoid drop-offs.",
  },
];
                        ...
                        <div className="grid lg:grid-cols-[432px_1fr] gap-8 lg:gap-16 items-center max-w-[1320px] mx-auto px-8">
                            ...
                            <div className="text-center lg:text-left space-y-6 lg:space-y-8 max-w-[848px]">
                                ...
                                <p className="font-open-sans text-xl lg:text-[21px] text-sales-subtitle max-w-[800px] mx-auto lg:mx-0">
                                    Organizations & institutions using our mobile platform report: 
                                </p>
