...
const benefits = [
  {
    ...
    description:
      'Get new hires and students productive faster with structured learning. ',
  },
  {
    title: ' Higher Completion Rates',
    description:
      'Gamified milestones, certifications, and AI reminders improve outcomes.',
  },
  {
    title: 'Talent Visibility',
    description:
      'Discover hidden performers through learning analytics and engagement.',
  },
  {
    title: ' Career Progression',
    description:
      'Offer internal mobility and career planning through structured learning.',
  },
];
      ...
      <div className="max-w-[1440px] lg:mx-20 sm:mx-10">
        <div className="grid lg:grid-cols-[550fr,848fr] gap-8 lg:gap-16 items-start mb-16">
          ...
          <div className="space-y-8 lg:space-y-12">
            ...
            <h2 className="font-inter text-3xl sm:text-2xl md:text-4xl lg:text-[42px] font-bold text-[#014D68] leading-tight lg:leading-[56px] tracking-[-1px] text-center lg:text-left">
              Benefits to Institutions & Teams
            </h2>
        ...
        <div className="text-center">
          <h2 className="font-open-sans text-4xl sm:text-2xl md:text-6xl lg:text-[50px] font-bold text-[#014D68] leading-normal">
            Learning Paths transforms your institution into a learning ecosystem where growth isn&rsquo;t just a possibility, it&rsquo;s a process. 
          </h2>
        </div>
      </div>
    </section>
