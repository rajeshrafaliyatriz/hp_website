...
const features = [
  {
    ...
    description:
      "AI-based risk modeling to help you stay ahead of leadership exits.",
  },
  {
    title: "Customizable Leadership Profiles",
    description:
      "Tailor leadership metrics to align with your organizational culture and goals.",
  },
  {
    title: "HiPo Development Journeys",
    description:
      "Structured growth paths and mentoring to nurture internal talent. ",
  },
];
            ...
            <div className="lg:grid lg:grid-cols-[1fr_530px] gap-6 lg:gap-16 items-center">
                ...
                <div className="space-y-4 lg:space-y-8">
                    ...
                    <h2 className="font-urbanist text-3xl sm:text-3xl lg:text-[32px] font-bold text-black leading-tight max-w-[880px]">
                        What Makes Leadership Shield Different?
                    </h2>
                        ...
                        <div className="grid lg:grid-cols-[432px_1fr] gap-8 lg:gap-16 items-center max-w-[1320px] mx-auto px-8">
                            ...
                            <div className="text-center lg:text-left space-y-6 lg:space-y-8 max-w-[848px]">
                                ...
                                <p className="font-open-sans text-xl lg:text-[21px] text-sales-subtitle max-w-[800px] mx-auto lg:mx-0">
                                    Companies using Leadership Shield have reported:  
                                </p>

                                {/* CTA Button */}
                                <div className="flex justify-center lg:justify-start">
                                    <button className="inline-flex items-center justify-center px-4 py-3 bg-[#014D68] hover:bg-[#014D68]/90 border border-sales-blue rounded-xl text-white font-inter font-bold text-lg transition-colors duration-200 h-[44px] w-auto">
                                        Talk to Our Experts 
                                    </button>
                                </div>
                            </div>
