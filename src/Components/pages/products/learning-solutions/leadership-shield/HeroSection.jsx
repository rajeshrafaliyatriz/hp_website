          ...
          <div className="grid lg:grid-cols-[700px_1fr] gap-8 lg:gap-12 items-center ">
            ...
            <div className="space-y-6 lg:space-y-6 ml-5">
              ...
              <h1 className="font-urbanist text-3xl sm:text-4xl lg:text-[38px] font-bold leading-tight lg:leading-[50.2px]">
                <span className="text-sales-text">Secure Tomorrow&rsquo;s <br/> Leaders Today  </span>
              ...
              <p className="font-urbanist text-lg sm:text-xl lg:text-[19px] text-sales-subtitle font-medium leading-relaxed lg:leading-[34.5px] max-w-[465px]">
                Leadership Shield equips your organization with intelligent tools to identify high-potential talent, simulate leadership pipelines, and mitigate succession risks ensuring you&apos;re always future-ready. 
              </p>

              {/* CTA Button */}
              <button className="inline-flex items-center justify-center px-4 py-3 bg-[#014D68] hover:bg-sales-primary/90 border border-sales-blue rounded-xl text-white font-inter font-bold text-lg transition-colors duration-200 h-[44px] w-auto">
                Get Leadership Insights Now 
              </button>
            </div>
