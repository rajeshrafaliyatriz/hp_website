      ...
      <div className="relative max-w-[1470px] lg:mx-40 px-4 sm:px-6 lg:px-8 py-12 lg:py-12">
        ...
        <div className="relative max-w-[1290px]">
          <div className="grid lg:grid-cols-[700px_1fr] gap-8 lg:gap-12 items-center ">
            {/* Left Content */}
            <div className="space-y-6 lg:space-y-7 ml-5">
              {/* Main Heading */}
              <h1 className="font-urbanist text-3xl sm:text-4xl lg:text-[38px] font-bold leading-tight lg:leading-[50.2px]">
                Simplify Expense Tracking & Stay in Control
              </h1>

              {/* Subtitle */}
              <p className="font-urbanist text-lg sm:text-xl lg:text-[19px] text-sales-subtitle font-medium leading-relaxed lg:leading-[34.5px] max-w-[650px]">
                Managing petty cash shouldn&rsquo;t be complicated. With our Petty Cash & Expense Management module, you can effortlessly record, track, and monitor every expense from small office purchases to travel reimbursements. 
              </p>
