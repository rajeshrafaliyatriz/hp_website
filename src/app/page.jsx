...
export const metadata = generateMetadata({
    title: 'GapsToGrowth - We find, fix skill & competency gaps—role by role, task by task',
    description: 'GapsToGrowth HP is a leading AI-powered University Management System (ERP) for universities, colleges, and K-12 schools in Himachal Pradesh. Comprehensive solutions for Talent Management, Learning & Development, Finance & HR.',
    keywords: [
